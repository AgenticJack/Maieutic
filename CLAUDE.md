# Maieutic — Vault Instructions for the AI Assistant (14.0)
...
1. Read `.claude/skills/pkm-principles14.0.md` in full
...
8. Check for `.claude/skills/tutorial-mode14.0.md` (or current version). If present, read it in full
...
Created during the monthly meeting. Full procedure in monthly-meeting-skill14.0.md.
...
```
> [!ai-generated] Generated by Claude Code — YYYY-MM-DD
> [content here]
```

Never flat into a note body. Exception: verbatim user synthesis goes directly
into the Synthesis section — it is user-generated. Evaluation callouts ARE
AI-generated and use the callout format.
...
always with [!ai-generated] callout.
